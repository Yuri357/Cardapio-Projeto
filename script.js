...
function addToCart(name, price){
    ...
    if(existingItem){
        //se existe o item, aumenta a quantidade + 1
...
// Adicionar Endereco no input
addressInput.addEventListener("input", function(event){
   let inuputValue = event.target.value;
...
// Enviar o pedido para API do whatsappWeb
...
// Verificar a hora e mudar o card do horario
